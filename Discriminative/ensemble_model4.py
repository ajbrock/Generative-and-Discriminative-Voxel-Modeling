...
lr_schedule = { 0: 0.002,25:0.0002} # may want to stick this out to 30
...
def get_model():
    ...
    l_conv16 = InceptionLayer(incoming = NL(BN(l_conv15,name='bn_conv15'),elu), 
            param_dict = [{'num_filters':[128],
                ...
                'bnorm':[0,0]}],
            block_name = 'conv16')
    l_conv17 = ResDrop(incoming = l_conv16, 
        IB = InceptionLayer(incoming = NL(BN(l_conv16,name='bn_conv16'),elu), 
            param_dict = [{'num_filters':[128,128,256],
                ...
                'style': ['convolutional']*2,
                'bnorm':[1,0]}],
            block_name = 'conv17'),p=0.35)
    l_conv18 = ResDrop(incoming = l_conv17, 
        IB = InceptionLayer(incoming = NL(BN(l_conv17,name='bn_conv17'),elu), 
            param_dict = [{'num_filters':[128,128,256],
                'filter_size':[(1,1,1),(3,3,3),(1,1,1)],
                'border_mode':['same']*3,
                'strides':[(1,1,1)]*3,
                ...
                'style': ['convolutional']*2,
                'bnorm':[1,0]}],
            block_name = 'conv18'),p=0.30)
    l_conv19 = ResDrop(incoming = l_conv18, 
        IB = InceptionLayer(incoming = NL(BN(l_conv18,name='bn_conv18'),elu), 
            param_dict = [{'num_filters':[128,128,256],
                'filter_size':[(1,1,1),(3,3,3),(1,1,1)],
                'border_mode':['same']*3,
                'strides':[(1,1,1)]*3,
                ...
                'style': ['convolutional']*2,
                'bnorm':[1,0]}],
            block_name = 'conv19'),p=0.25)        
    l_conv20 = InceptionLayer(incoming = NL(BN(l_conv19,name='bn_conv19'),elu), 
            param_dict = [{'num_filters':[256],
                'filter_size':[(3,3,3)],
                'border_mode':['same'],
                'strides':[(2,2,2)],
                'nonlinearity': [elu],
    ...
    l_pool = BN(lasagne.layers.GlobalPoolLayer(l_conv20),name='l_pool')
